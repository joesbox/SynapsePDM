...
#ifndef TFT_INIT_POST_RESET_DELAY_MS
  #define TFT_INIT_POST_RESET_DELAY_MS 150
#endif

#ifndef TFT_INIT_RESET_HIGH_DELAY_MS
  #define TFT_INIT_RESET_HIGH_DELAY_MS 5
#endif

#ifndef TFT_INIT_RESET_LOW_DELAY_MS
  #define TFT_INIT_RESET_LOW_DELAY_MS 20
#endif
...
void TFT_eSPI::init(uint8_t tc)
{
  ...
  if (TFT_RST >= 0) {
    ...
    delay(TFT_INIT_RESET_HIGH_DELAY_MS);
    digitalWrite(TFT_RST, LOW);
    delay(TFT_INIT_RESET_LOW_DELAY_MS);
    digitalWrite(TFT_RST, HIGH);
  }
  ...
  delay(TFT_INIT_POST_RESET_DELAY_MS); // Wait for reset to complete
